...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/mriveran/Documents/psychopy_exps/esi_study_run2.py',
...
study_trials = data.TrialHandler(nReps=1.0, method='sequential', 
    ...
    trialList=data.importConditions('esi_study_run2_stim.xlsx'),
